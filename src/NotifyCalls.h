...
namespace scpar {
  ...
  public:
    ...
    // Constructors.
    NotifyCalls();
    NotifyCalls(const string&, FindNotify::notifyCallListType, FindNotify::processNotifyEventMapType);
    ...
    string getName();
		...
		FindNotify::processNotifyEventMapType getProcessNotifyEventMap();
