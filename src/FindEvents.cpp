...
FindEvents::classEventMapType FindEvents::getInClassEvents() {  // FIXME: change to return data structure
...
void FindEvents::dump() {
  ...
  for(classEventMapType::iterator vit = _inClassEvents.begin(); vit!= _inClassEvents.end(); vit++) {
