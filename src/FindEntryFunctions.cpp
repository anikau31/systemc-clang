...
FindEntryFunctions::FindEntryFunctions(CXXRecordDecl *d, llvm::raw_ostream &os)
    : os_{os}, _d{d}, is_entry_function_{false}, proc_type_{PROCESS_TYPE::NONE},
      entry_cxx_record_decl_{nullptr}, entry_method_decl_{nullptr},
      found_entry_decl_{false}, constructor_stmt_{nullptr}, pass_{1} {
