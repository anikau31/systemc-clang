...
static DeclarationMatcher matchModuleDeclarations = cxxRecordDecl(isDerivedFrom("sc_module")).bind("sc_module");
class ModuleDeclarationMatcher : public MatchFinder::MatchCallback {
  public:
    typedef std::vector< std::tuple<std::string, const CXXRecordDecl*> > ModuleDeclarationTuple;
