...
ProcessDecl::ProcessDecl(string t, string n, CXXMethodDecl *entryMethodDecl,
    ...
    : _type(t), _entryName(n), _entryMethodDecl(entryMethodDecl), _ef(e) {}

ProcessDecl::~ProcessDecl() {
  // The following points do NOT need to be deleted:_entryMethodDecl,
...
string ProcessDecl::getType() { return _type; }

string ProcessDecl::getName() { return _entryName; }

CXXMethodDecl *ProcessDecl::getEntryMethodDecl() { return _entryMethodDecl; }
