...
namespace scpar {
  ...
  public:
    ...
    typedef pair<string, CXXRecordDecl*> kvType;
   
  public:
    SCModules(TranslationUnitDecl*, llvm::raw_ostream&);
 //   SCModules(TranslationUnitDecl*, llvm::raw_ostream&, reflectionDataStructure*);

    virtual bool VisitCXXRecordDecl(CXXRecordDecl*);

    moduleMapType getSystemCModulesMap();
    //reflectionDataStructure * getSystemCModulesMap();
