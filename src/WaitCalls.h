...
namespace scpar {
  ...
  public:
    ...
    // Constructors.
    WaitCalls();
    WaitCalls(const string&, FindWait::waitListType, FindWait::waitTimesMapType, 
		FindWait::processWaitEventMapType);
    ...
    FindWait::waitTimesMapType getWaitTimes();
		FindWait::processWaitEventMapType getProcessWaitEventMap();
  ...
  private:
    string _name;
		...
		FindWait::processWaitEventMapType _processEventMap;
  };
}
#endif
