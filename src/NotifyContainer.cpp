...
unsigned int NotifyContainer::getNumArgs() { return _numArgs; }

CXXMethodDecl *NotifyContainer::getEntryMethod() { return _entryMethodDecl; }

CallExpr *NotifyContainer::getASTNode() { return _astNode; }
