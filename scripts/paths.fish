...
# SET this.
set -x LLVM_INSTALL_DIR /home/$USER/bin/clang-13.0.0/
...
set -x SYSTEMC_CLANG /home/$USER/code/github/rseac/fccm/systemc-clang/

# Path for the systemc-clang build directory
# SET this.
set -x SYSTEMC_CLANG_BUILD_DIR /home/$USER/code/github/rseac/fccm/systemc-clang-build/
##===================================================================
