...
#$LLVM_INSTALL_DIR/bin/systemc-clang $1 $2 -- -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS  -I/usr/include -I$SYSTEMC/include -x c++ -w -c 

$LLVM_INSTALL_DIR/bin/systemc-clang $1 $2 -- -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS  -I/usr/include -I$LLVM_INSTALL_DIR/lib/clang/9.0.0/include -I$SYSTEMC/include -x c++ -w -c 
