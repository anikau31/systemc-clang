...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ADVANCED_PROPERTIES {\
     __view__ {functional { S00_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE\
4 } M01_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 }\
S01_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 }\
M00_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 }\
M02_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } S00_Entry\
{ SUPPORTS_WRAP 1 } }}\
   } \
   CONFIG.NUM_CLKS {2} \
   CONFIG.NUM_MI {4} \
