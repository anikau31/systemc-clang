...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ADVANCED_PROPERTIES {    __view__ { functional { S00_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } M01_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } S01_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } M00_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } M02_Buffer { AR_SIZE 4 AW_SIZE 4 B_SIZE 4 R_SIZE 4 W_SIZE 4 } S00_Entry { SUPPORTS_WRAP 1 } } }   } \
   CONFIG.NUM_CLKS {2} \
   CONFIG.NUM_MI {3} \
   CONFIG.NUM_SI {2} \
 ] $smartconnect_0
  ...
  connect_bd_intf_net -intf_net axi_mcdma_0_M_AXI [get_bd_intf_pins axi_mcdma_0/M_AXI] [get_bd_intf_pins smartconnect_1/S00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk100mhz [get_bd_ports clk100mhz_0] [get_bd_pins clk_wiz_0/clk100mhz] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk25mhz [get_bd_ports clk25mhz_0] [get_bd_pins clk_wiz_0/clk25mhz] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk50mhz [get_bd_ports clk50mhz_0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mcdma_0/s_axi_aclk] [get_bd_pins axi_mcdma_0/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk50mhz] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports locked_0] [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins proc_sys_reset_1/aux_reset_in]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_ports interconnect_aresetn_0] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_ports peripheral_aresetn_0] [get_bd_pins axi_mcdma_0/axi_resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_mcdma_0/Data_SG] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_mcdma_0/Data_SG] [get_bd_addr_segs axi_mcdma_0/S_AXI_LITE/Reg]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
