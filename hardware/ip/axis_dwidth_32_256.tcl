set ip_name "axis_dwidth_32_256"
create_project -in_memory -part $part
create_ip -name axis_dwidth_converter -vendor xilinx.com -library ip -version 1.1 -module_name $ip_name
set_property -dict [list CONFIG.S_TDATA_NUM_BYTES {4} CONFIG.M_TDATA_NUM_BYTES {32} CONFIG.Component_Name {$ip_name}] [get_ips $ip_name]
