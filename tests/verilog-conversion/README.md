...
Make sure that the output contains the lines presented, which include the path of the used Python interpreter.


## Adding a test

Within the test framework, we provide a simple way for the user to add tests for the following purpose:
1. Test the conversion from a SystemC design file to \_hdl.txt and compare the generated \_hdl.txt against a golden standard
2. Test the conversion from \_hdl.txt to Verilog and compare the generated Verilog against a golden standard
3. Test the conversion from a SystemC design file to Verilog and compared the generated \_hdl.txt and Verilog to golden standard files
