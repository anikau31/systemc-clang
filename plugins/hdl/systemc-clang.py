...
class SystemCClang:
    ...
    def execute(self, args, target_name=None):
        ...
        args_to_sysc = args + ["-I{}".format(self.systemc_inc_dir), ]
        ...
        result = SystemCClang.__get_systemc_clang_output_files(args)
        for t in result:
            if not Path(t).exists():
                raise SystemCClangFatalError('Target file: {} is not generated by systemc-clang binary'.format(t))
        return result
