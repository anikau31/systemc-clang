...
// 
//
// File Name    : tb_decim.cpp
// Description  : Testbench for decimation filter
...
//----------------------------------------------------------------------------------------
//31/07/2013    1.0     PolyU        Decimation filter original testbench
//
//=======================================================================================
#include "tb_decim.h"
...
//-----------------------------
void test_decim::compare_results(){
